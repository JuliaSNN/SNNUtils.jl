quaresima2023 = (
    ...
    connectivity = (
        ...
        E_to_If = (p = 0.2, μ = log(16.0), dist = LogNormal, σ = 0.0),
        E_to_Is = (p = 0.2, μ = log(16.0), dist = LogNormal, σ = 0.0),
        If_to_E = (p = 0.2, μ = log(16.8), dist = LogNormal, σ = 0),
        If_to_Is = (p = 0.2, μ = log(5.83), dist = LogNormal, σ = 0.0),
        If_to_If = (p = 0.2, μ = log(16.2), dist = LogNormal, σ = 0.0),
        Is_to_Ed = (p = 0.2, μ = log(16.0), dist = LogNormal, σ = 0),
        Is_to_If = (p = 0.2, μ = log(5.47), dist = LogNormal, σ = 0.0),
