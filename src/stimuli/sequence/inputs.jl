...
function step_input(;
    ...
    variables = Dict(:decay=>decay_rate, :peak=>peak_rate, :start=>start_rate, :intervals=>Float32[])
...
export step_input_sequence, randomize_sequence!, dummy_input, attack_decay, update_stimuli!, set_stimuli!, sign_intervals, all_intervals